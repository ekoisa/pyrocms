...
<div class="tabs" role="tabpanel">
	...
	<ul class="tab-menu nav nav-tabs bar_tabs" role="tablist">
		...
		<?php if ($stream_fields): ?><li><a href="#blog-custom-fields" data-toggle="tab"><span><?php echo lang('global:custom_fields') ?></span></a></li><?php endif; ?>
		<li><a href="#blog-options-tab" data-toggle="tab"><span><?php echo lang('blog:options_label') ?></span></a></li>
	</ul>

	<!-- Content tab -->
	<div class="form_inputs tab-pane fade active" id="blog-content-tab" role="tabpanel">
		<fieldset>
			<ul>
				<li>
	...
	<div class="form_inputs tab-pane fade" id="blog-custom-fields" role="tabpanel">
		<fieldset>
			<ul>
	...
	<!-- Options tab -->
	<div class="form_inputs tab-pane fade" id="blog-options-tab" role="tabpanel">
		<fieldset>
			<ul>
