<div id="comment-preview">
	...
	<div class="float-right spacer-right buttons buttons-small">
		<?php if ($comment->is_active): ?>
			<?php echo anchor('admin/comments/unapprove/'.$comment->id, lang('global:unapprove'), 'class="btn btn-default btn-sm"') ?>
		<?php else:?>
			<?php echo anchor('admin/comments/approve/'.$comment->id, lang('global:approve'), 'class="btn btn-default btn-sm"') ?>
		<?php endif?>
		<?php echo anchor('admin/comments/delete/'.$comment->id, lang('global:delete'), 'class="btn btn-default btn-sm"')?>
	</div>
