						...
						<?php foreach ($page_types as $page_type): ?>
							<tr>
								...
								<td class="actions">
									...
									<?php echo anchor('admin/pages/types/sync/'.$page_type->id, lang('page_types:sync_files'), array('class'=>'btn btn-default btn-sm'));?> 
									<?php endif; ?>
	
									<?php echo anchor('admin/pages/types/fields/'.$page_type->id, lang('global:fields'), array('class'=>'btn btn-default btn-sm'));?> 
									<?php echo anchor('admin/pages/types/edit/' . $page_type->id, lang('global:edit'), array('class'=>'btn btn-default btn-sm'));?> 
									<?php if ($page_type->slug !== 'default') echo anchor('admin/pages/types/delete/' . $page_type->id, lang('global:delete'), array('class'=>'btn btn-default btn-sm'));?>
								</td>
							</tr>
						<?php endforeach; ?>
					</tbody>
