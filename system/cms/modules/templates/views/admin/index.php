				...
				<?php if($template->is_default): ?>
		            <tr>
						...
						<div class="buttons buttons-small align-center">
							<?php echo anchor('admin/templates/preview/' . $template->id, lang('buttons:preview'), 'class="btn btn-default btn-sm preview modal"') ?>
		                    <?php echo anchor('admin/templates/edit/' . $template->id, lang('buttons:edit'), 'class="btn btn-default btn-sm edit"') ?>
							<?php echo anchor('admin/templates/create_copy/' . $template->id, lang('buttons:clone'), 'class="btn btn-default btn-sm clone"') ?>
						</div>
		                </td>
		            </tr>
				<?php endif ?>
...
<div class="col-xs-12">
	...
	<section class="col-xs-12 item">
		<div class="content">
			<table border="0" class="table table-striped clear-both" cellspacing="0">
		        <thead>
		            <tr>
		                <th><?php echo form_checkbox(array('name' => 'action_to_all', 'class' => 'check-all'));?></th>
		                <th><?php echo lang('name_label') ?></th>
				...
				<?php if(!$template->is_default): ?>
		            <tr>
						...
						<div class="buttons buttons-small align-center">
							<?php echo anchor('admin/templates/preview/' . $template->id, lang('buttons:preview'), 'class="btn btn-default btn-sm preview modal"') ?>
		                    <?php echo anchor('admin/templates/edit/' . $template->id, lang('buttons:edit'), 'class="btn btn-default btn-sm edit"') ?>
							<?php echo anchor('admin/templates/delete/' . $template->id, lang('buttons:delete'), 'class="btn btn-default btn-sm delete"') ?>
						</div>
		                </td>
		            </tr>
				<?php endif ?>
