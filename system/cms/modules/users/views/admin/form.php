...
<section class="col-xs-12 item">
	<div class="content">
		...
		<div class="tabs" role="tabpanel">
			...
			<div class="form_inputs tab-pane fade active in" id="user-basic-data-tab" role="tabpanel">
				<fieldset>
					<ul class="to_do">
						<li class="even">
			...
			<div class="form_inputs tab-pane fade" id="user-profile-fields-tab" role="tabpanel">
