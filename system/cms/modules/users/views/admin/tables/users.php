<?php if (!empty($users)): ?>
	<table border="0" class="table table-striped" cellpadding="0" cellspacing="0">
		<thead>
			<tr>
		...
		<tbody>
			...
			<?php foreach ($users as $member): ?>
				<tr>
					...
					<td class="actions">
						<?php echo anchor('admin/users/edit/' . $member->id, lang('global:edit'), array('class'=>'btn btn-default btn-sm edit')) ?>
						<?php echo anchor('admin/users/delete/' . $member->id, lang('global:delete'), array('class'=>'confirm btn btn-danger btn-sm delete')) ?>
					</td>
				</tr>
			<?php endforeach ?>
		</tbody>
