				...
				<tbody>
					...
					<tr>
						...
						<?php if ($widgets_active): ?>
							<?php echo anchor('admin/widgets/disable/' . $widget->id, lang('buttons:disable'), 'class="btn btn-default btn-sm disable"') ?>
						<?php else: ?>
							<?php echo anchor('admin/widgets/enable/' . $widget->id, lang('buttons:enable'), 'class="btn btn-default btn-sm enable"') ?>
						<?php endif ?>
						</td>
					</tr>
					<?php endforeach ?>
