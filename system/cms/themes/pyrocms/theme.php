...
class Theme_Pyrocms extends Theme {
    ...
    public $name			= 'Momotrip - Admin Theme';
    public $author			= 'Momotrip Team';
    public $author_website	= 'http://www.momotrip.co.id/';
    public $website			= 'http://www.momotrip.co.id/';
    public $description		= 'Momotrip admin theme. HTML5 and CSS3 styling.';
