...
Asset::js('nprogress.js');
Asset::js('bootstrap.min.js');
Asset::js('progressbar/bootstrap-progressbar.min.js');
Asset::js('nicescroll/jquery.nicescroll.min.js');
Asset::js('moment/moment.min.js');
Asset::js('datepicker/daterangepicker.js');
Asset::js('custom.js');
